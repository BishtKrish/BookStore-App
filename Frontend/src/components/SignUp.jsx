                    ...
                    <div className="modal-box dark:bg-slate-900 dark:text-white">
                        <form onSubmit={handleSubmit(onSubmit)} method="dialog">
                            ...
                            <div className='mt-4 space-y-2 '>
                                <span>Name</span>
                                <br />
                                <input type="text" placeholder='Enter your name' className='text-black w-80 px-3 py-1 border rounded-md outline-none dark:bg-slate-900 dark:text-white'
                            ...
                            <div className='mt-4 space-y-2 '>
                                <span>Password</span>
                                <br />
                                <input type="text" placeholder='Enter your password' className='text-black w-80 px-3 py-1 border rounded-md outline-none dark:bg-slate-900 dark:text-white'
