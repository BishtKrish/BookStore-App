...
function Navbar() {
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer ">GyaanGriha</a>
  </div>
...

{
  authUser?<Logout/>:
  <div className="">
    <a className="bg-red-500 text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
    <Login/>
  </div>
}
